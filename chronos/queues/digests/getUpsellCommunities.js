...
export const getUpsellCommunities = async (
  ...
  // if the user has joined less than the threshold number of communities, take the top communities on Keyy, remove any that the user has already joined, and slice the first 3 to send into the email template
