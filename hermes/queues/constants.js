...
export const NEW_MESSAGE_TEMPLATE = mapTemplate(
  IS_PROD
    ? 'd-1379042b64ba4c6093fecaec7161480a'
    : 'd-7a4c14fd440146f1b1cfcafb633bb040'
);
export const NEW_MENTION_THREAD_TEMPLATE = mapTemplate(
  IS_PROD
    ? 'd-343ec51df23943e88d0709aa8e30312b'
    : 'd-ff421ea0112a4525b6615bcc666ede00'
);
export const NEW_MENTION_MESSAGE_TEMPLATE = mapTemplate(
  IS_PROD
    ? 'd-5ef46b71baee4c67bc46ab867e14d5bb'
    : 'd-637189bc871744e9846694bff9f572ae'
);
export const NEW_DIRECT_MESSAGE_TEMPLATE = mapTemplate(
  IS_PROD
    ? 'd-d959535dd2304830ad14e1850297f46d'
    : 'd-3e289af9efe748308be2dde1d3786c0d'
);
export const NEW_USER_WELCOME_TEMPLATE = mapTemplate(
  IS_PROD
    ? 'd-57c4111b847d4554b5d71f9fcf9170f8'
    : 'd-2e46e5b65abc42b78941fbe027be4cd5'
);
export const COMMUNITY_INVITE_TEMPLATE = mapTemplate(
  IS_PROD
    ? 'd-566d2a20ca9246108a55a4b4037b9e53'
    : 'd-69b2e17b7a0f46048dcf4083ad4f9c48'
);
export const NEW_COMMUNITY_WELCOME_TEMPLATE = mapTemplate(
  IS_PROD
    ? 'd-3a72aa9dec664ab4badd20e17586f477'
    : 'd-dc7b4f048f4c460f9dd368fd3796421b'
);

export const NEW_THREAD_CREATED_TEMPLATE = mapTemplate(
  IS_PROD
    ? 'd-2809d28ff1cc4d89a503e04de3388411'
    : 'd-084c11332981443388ebdae05d0a2ff4'
);
export const DIGEST_TEMPLATE = mapTemplate(
  IS_PROD
    ? 'd-54e8d4905da64158a98ddb92c9330583'
    : 'd-5e52250c25be4654af82172970551919'
);
export const EMAIL_VALIDATION_TEMPLATE = mapTemplate(
  IS_PROD
    ? 'd-8cd6c640e2d944c7a4bb8877722ff00f'
    : 'd-9fbb3cc969364050aac891c255d31209'
);
export const ADMINISTRATOR_EMAIL_VALIDATION_TEMPLATE = mapTemplate(
  IS_PROD
    ? 'd-c7ab6234c65b47d88413d9deaae0f7f1'
    : 'd-a60e1df2d5294c73818759be13f09df4'
);

export const ADMIN_COMMUNITY_CREATED_TEMPLATE = mapTemplate(
  'd-8220ddfc3d3a436a9ea974348c9c2edd'
);
export const ADMIN_TOXIC_MESSAGE_TEMPLATE = mapTemplate(
  'd-f6e52c81dd8d49e29f23c5c6112d676b'
);
export const ADMIN_SLACK_IMPORT_PROCESSED_TEMPLATE = mapTemplate(
  'd-b3f8d36ef3354ce987a352ce39893432'
);
export const ADMIN_ACTIVE_COMMUNITY_REPORT_TEMPLATE = mapTemplate(
  'd-82812e47e2ea458c8ded5be8d3de4f48'
);
export const ADMIN_USER_SPAMMING_THREADS_NOTIFICATION_TEMPLATE = mapTemplate(
  'd-65de04a810d84af7b76a57f7b4b6ebbe'
);
export const ADMIN_USER_REPORTED_TEMPLATE = mapTemplate(
  'd-7340d2f62edd4af6a4c95f87a8d4e1c6'
);

export const PRIVATE_CHANNEL_REQUEST_SENT_TEMPLATE = mapTemplate(
  IS_PROD
    ? 'd-fe75baaf293541889bd3a573c2d9b1c5'
    : 'd-29f3f62815004e0bb3b9f884c9fb3901'
);
export const PRIVATE_CHANNEL_REQUEST_APPROVED_TEMPLATE = mapTemplate(
  IS_PROD
    ? 'd-b419b76ca66046b3b24ead7b3a0cbb36'
    : 'd-6bc3fffa3fa64e369035bc906b3975dd'
);

export const PRIVATE_COMMUNITY_REQUEST_SENT_TEMPLATE = mapTemplate(
  IS_PROD
    ? 'd-0e21a47bdce348a093c86b8779d84687'
    : 'd-743d07e016ee4798a87c06b5dd0a27a1'
);
export const PRIVATE_COMMUNITY_REQUEST_APPROVED_TEMPLATE = mapTemplate(
  IS_PROD
