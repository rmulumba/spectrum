              ...
              if (!searchResults || searchResults.length === 0) {
                ...
                const heading =
                  searchString.length > 1
                    ...
                    : 'Search for people in your learning group';

                const subheading =
                  searchString.length > 1
                    ? 'Grow your learning group by inviting people via email, or by importing a Slack team'
                    : 'Find people by name, username, and portfolio description - try searching for "designer" or "developer"';
                  ...
                  <ListContainer data-cy="community-settings-members-list">
                    {filter && filter.isBlocked && !community.isPrivate && (
                      <Notice>
                        ...
                        see the content and conversations in your learning
                        group. However, they will be prevented from creating new
